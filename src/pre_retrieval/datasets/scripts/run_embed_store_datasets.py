...
def main() -> int:
    ...
    master_path = resolve_repo_path("data/intermediate/raw_datasets/datasets_master.jsonl")
    if questions_path.exists() and master_path.exists():
        check_gold_target_coverage(questions_path, master_path, "dataset", "dataset_id")
